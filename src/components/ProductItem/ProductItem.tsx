import { Breadcrumbs, Button, Chip, Link, ToggleButton, ToggleButtonGroup, Typography } from '@mui/material'
...
export const ProductItem = (): JSX.Element => {
  return (
    <Container sx={{ minHeight: '100vh' }}>
      <Container>
        <Breadcrumbs aria-label="breadcrumb" sx={{ fontSize: '12px', marginTop: '20px' }}>
        ...
        <Typography variant="body2" color="text.secondary" mt={'20px'}>
          ...
          quisquam obcaecati quaerat nostrum beatae adipisci non porro alias nulla maiores a reiciendis velit fugiat
          iste commodi officiis iusto voluptates, nihil, distinctio at consectetur, ex quis in? Saepe excepturi placeat
          maxime.
        </Typography>
      </Container>
    </Container>
